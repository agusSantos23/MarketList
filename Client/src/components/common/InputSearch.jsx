    ...
    return (
      <div className="relative w-auto ">
        <img 
          src={hashtagSVG} 
          alt="hashtag" 
          className="w-4 absolute left-2 top-1/2 -translate-y-1/2"  
        />
  
        <input 
          type="text"
          onChange={onSearch}
          className="pl-7 pr-1  text-lg bg-myWhite rounded-md border-2 border-purple-300 border-t-purple-200 border-l-purple-200 border-b-purple-400 border-r-purple-400 shadow-md shadow-purple-300 focus:outline-none focus:border-transparent "
        />
      </div>
    )
